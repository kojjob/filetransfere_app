...
```bash
export ALLOWED_ORIGINS=https://flowtransfer.com,https://www.flowtransfer.com
```
...
export PHX_HOST=api.flowtransfer.com
export ALLOWED_ORIGINS=https://flowtransfer.com
...
3. **Set Secrets**
   ...
   fly secrets set ALLOWED_ORIGINS=https://flowtransfer.com
   fly secrets set PHX_HOST=api.flowtransfer.com
   ```
...
curl -X POST https://api.flowtransfer.com/api/waitlist \
  ...
  -H "Origin: https://flowtransfer.com" \
